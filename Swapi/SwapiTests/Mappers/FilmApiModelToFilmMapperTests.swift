...
class FilmApiModelToFilmMapperTests: XCTestCase {
    ...
    func test_filmApiModelToFilm_shouldBeSuccessful() throws {
        ...
        let expectedFilm = Film(title: "A New Hope", openingCrawl: "It is a period of Civil War", releaseDate: expectedDate)

        let filmApiModel = FilmApiModel(title: "A New Hope", openingCrawl: "It is a period of Civil War", releaseDate: "1995-10-20")
